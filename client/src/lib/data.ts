// MetLife EMEA AI Command Center — Synthetic Data Model
// All figures are illustrative for discussion only and do not represent actual MetLife data.

export const METLIFE_COLORS = {
  blue: '#0090DA',
  green: '#5DA831',
  greenLight: '#8CC63F',
  amber: '#E0992E',
...
export const AI_TOOLS: AITool[] = [
  ...
  },
  {
    ...
    yearlyValue: 18.7,
    usagePercent: 91,
    model: 'MetIQ Risk Classifier v3',
    costPerUse: 1.8,
    usesPerMonth: 72000,
  ...
  },
  {
    ...
    description: 'Assists MetLife engineers with code generation, review, and documentation, accelerating delivery of the MetIQ platform itself.',
    function: 'Technology',
    leadMarket: 'Center',
  ...
  },
  {
    ...
    description: 'Monitors regulatory publications across EMEA markets and flags changes that affect MetLife products or operations, with a plain-language summary.',
...
export const GLOSSARY = [
  ...
  { term: 'MetIQ', definition: 'MetLife\'s own AI platform that powers all the tools shown in this dashboard. Every tool runs on MetIQ.' },
  { term: 'New Frontier', definition: 'MetLife\'s strategic framework with four priorities: Group Benefits leadership, retirement platform, asset management, and international market growth.' },
  { term: 'Responsible AI', definition: 'The seven principles MetLife uses to govern AI: Fairness, Transparency, Privacy, Accountability, Performance, Data Governance, and Resiliency.' },
